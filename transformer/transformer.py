...
# new_model = keras.models.load_model('transformer.h5')
...
def sentiment_predict(new_sentence, word_index, model):
    encoded = list()
    ...
    print(f"y: {y_val[1]}, predict : { model.predict(np.array([x_val[0]])) }")
...
new_sentence = "this movie was good"
word_index = keras.datasets.imdb.get_word_index()
sentiment_predict(new_sentence, word_index, model)